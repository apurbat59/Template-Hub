    ...
    "Landing Pages": [
      {
        ...
        description: "Professional financial services landing page with trust indicators and conversion optimization",
        image: "/finance-landing-page.jpg",
        rating: 4.9,
        downloads: 1650,
        tags: ["Next.js", "Tailwind", "Framer Motion", "TypeScript"],
        price: "Free",
        demoUrl: "/templates/finance/landing-page-1",
        features: ["Trust Indicators", "Service Showcase", "Client Testimonials", "Contact Forms", "Compliance Ready"],
      },
    ],
    Dashboards: [
      {
        ...
        description: "Advanced trading dashboard with real-time data, charts, and portfolio management",
        image: "/finance-trading-dashboard.jpg",
        rating: 4.8,
        downloads: 1400,
        tags: ["React", "Chart.js", "WebSocket", "Tailwind", "TypeScript"],
        price: "Free",
        demoUrl: "/templates/finance/dashboard-1",
        features: ["Real-time Charts", "Portfolio Tracking", "Market Data", "Risk Analysis", "Trading Tools"],
      },
    ],
    Authentication: [
      {
        id: 3,
        name: "Secure Finance Auth",
        description: "Bank-grade authentication system with multi-factor authentication and compliance features",
        image: "/finance-authentication.jpg",
        rating: 4.9,
        downloads: 1200,
        tags: ["React", "JWT", "2FA", "Biometric", "Encryption"],
        price: "Free",
        demoUrl: "/templates/finance/auth-1",
        features: ["Multi-Factor Auth", "Biometric Login", "Fraud Detection", "Compliance Logs", "Secure Sessions"],
      },
    ],
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              <h1 className="text-5xl font-bold text-foreground mb-2">Finance Templates</h1>
              <p className="text-xl text-muted-foreground">
                Professional financial services templates for banks, trading platforms, and FinTech startups
              </p>
            </div>
          </div>
        </div>
