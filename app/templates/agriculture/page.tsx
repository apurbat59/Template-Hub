...
export default function AgricultureTemplatesPage() {
  const templatesByType = {
    "Landing Pages": [
      {
        id: 1,
        name: "Smart Farm Landing",
        description: "Modern agricultural technology landing page showcasing IoT solutions and precision farming",
        image: "/agriculture-landing-page.jpg",
        rating: 4.7,
        downloads: 890,
        tags: ["Next.js", "Tailwind", "Framer Motion", "TypeScript"],
        price: "Free",
        demoUrl: "/templates/agriculture/landing-page-1",
        features: ["IoT Integration", "Crop Monitoring", "Weather Data", "Farm Analytics", "Mobile Responsive"],
      },
    ],
    Dashboards: [
      {
        ...
        description: "Comprehensive farm management system with crop monitoring, weather data, and yield analytics",
        image: "/farm-management-dashboard.jpg",
        rating: 4.8,
        downloads: 720,
        tags: ["React", "Chart.js", "IoT", "Tailwind", "TypeScript"],
        price: "Free",
        demoUrl: "/templates/agriculture/dashboard-1",
        features: ["Crop Monitoring", "Weather Integration", "Yield Analytics", "Equipment Tracking", "Soil Analysis"],
      },
    ],
    Authentication: [
      {
        id: 3,
        name: "AgTech Auth System",
        description: "Secure authentication system for agricultural platforms with farmer and admin access levels",
        image: "/agriculture-authentication.jpg",
        rating: 4.6,
        downloads: 540,
        tags: ["React", "JWT", "Role-Based", "Tailwind", "TypeScript"],
        price: "Free",
        demoUrl: "/templates/agriculture/auth-1",
        features: ["Farmer Accounts", "Admin Access", "Equipment Login", "Data Security", "Mobile Support"],
      },
    ],
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              <h1 className="text-5xl font-bold text-foreground mb-2">Agriculture Templates</h1>
              <p className="text-xl text-muted-foreground">
                Smart farming solutions for modern agriculture, IoT integration, and precision farming
              </p>
            </div>
          </div>
        </div>
