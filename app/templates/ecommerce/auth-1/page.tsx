...
import { ShoppingBag, Gift, Eye, EyeOff, Mail, Lock, User, Phone } from "lucide-react"

export default function EcommerceAuth1() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      alert("Welcome back! Happy shopping!")
    }, 2000)
  }
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      alert("Account created! Welcome to our store!")
    }, 2000)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-pink-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="border-orange-200 shadow-lg">
          <CardHeader className="space-y-1 pb-4">
            <div className="flex items-center justify-center space-x-2 text-orange-600 mb-2">
              ...
              <span className="text-sm font-medium">Get 20% off your first order!</span>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 p-3 bg-gradient-to-r from-orange-100 to-pink-100 rounded-lg border border-orange-200">
              <div className="flex items-center space-x-2 text-orange-700">
                <Gift className="w-4 h-4" />
                <span className="text-sm font-medium">New customer? Get 20% off your first purchase!</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          <p>Secure checkout • Free shipping over $50 • 30-day returns</p>
        </div>
      </div>
    </div>
  )
