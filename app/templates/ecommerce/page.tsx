...
export default function EcommerceTemplatesPage() {
  const templatesByType = {
    "Landing Pages": [
      {
        id: 1,
        name: "E-commerce Store Landing",
        description: "Modern e-commerce landing page with product showcase and conversion optimization",
        image: "/ecommerce-store-interface.png",
        rating: 4.8,
        downloads: 2100,
        tags: ["Next.js", "Tailwind", "Stripe", "TypeScript"],
        price: "Free",
        demoUrl: "/templates/ecommerce/landing-page-1",
        features: ["Product Showcase", "Shopping Cart", "Payment Integration", "SEO Optimized", "Mobile Responsive"],
      },
    ],
    Dashboards: [
      {
        ...
        description: "Complete e-commerce management dashboard with analytics, inventory, and order management",
        image: "/ecommerce-dashboard.jpg",
        rating: 4.9,
        downloads: 1800,
        tags: ["React", "Next.js", "Chart.js", "Tailwind", "Prisma"],
        price: "Free",
    ...
    Authentication: [
      {
        ...
        description: "Secure customer and admin authentication with social login and account management",
        image: "/ecommerce-authentication-system.jpg",
        rating: 4.7,
        downloads: 1500,
        tags: ["React", "NextAuth", "OAuth", "JWT", "Tailwind"],
        price: "Free",
        demoUrl: "/templates/ecommerce/auth-1",
        features: ["Social Login", "Customer Accounts", "Admin Access", "Password Reset", "Email Verification"],
      },
    ],
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              <h1 className="text-5xl font-bold text-foreground mb-2">E-commerce Templates</h1>
              <p className="text-xl text-muted-foreground">
                Complete e-commerce solutions for online stores, marketplaces, and retail businesses
              </p>
            </div>
          </div>
        </div>
