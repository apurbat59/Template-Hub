...
import { Gamepad2, Zap, Eye, EyeOff, Mail, Lock, User, Shield } from "lucide-react"

export default function GamingAuth1() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      alert("Account created! Ready to game!")
    }, 2000)
  }
        ...
        <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm shadow-2xl">
          <CardHeader className="space-y-1 pb-4">
            <div className="flex items-center justify-center space-x-2 text-purple-400 mb-2">
              ...
              <span className="text-sm font-medium">Level Up Your Gaming</span>
            </div>
          </CardHeader>
          <CardContent>
